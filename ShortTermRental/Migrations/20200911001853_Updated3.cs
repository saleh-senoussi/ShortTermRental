    ...
    public partial class Updated3 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Payments", x => new { x.PropertyId, x.GuestId, x.HostId, x.BookingId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reviews", x => new { x.PropertyId, x.GuestId, x.BookingId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pricings", x => new { x.PropertyId, x.HostId });
                    table.ForeignKey(
                        name: "FK_Pricings_AspNetUsers_HostId",
                        column: x => x.HostId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
